      ...
      init() {
        ...
        if (this.dialogData.type == "add") {
          ...
          if (this.dialogData.segementType == '测评') {
            ...
            switch_type = JSON.parse(JSON.stringify(this.$parent.$parent.dialogData.param.textbook_segment_data_details[this.dialogData.index].resources_content.switch_type));
            question_ids = JSON.parse(JSON.stringify(this.$parent.$parent.dialogData.param.textbook_segment_data_details[this.dialogData.index].resources_content.question_ids));
