      ...
      <el-form :model="form" label-width="100px" size="small">
        ...
        <el-form-item label="评分区间">
          ...
          <div class="score-item">
            ...
            <cc-number-range v-model="form.rule[0]" min="0" max="100" maxlength="3"></cc-number-range>
          </div>

          <div class="score-item">
            <score-star star="2"></score-star>
            <cc-number-range v-model="form.rule[1]" min="0" max="100" maxlength="3"></cc-number-range>
          </div>

          <div class="score-item">
            <score-star star="3"></score-star>
            <cc-number-range v-model="form.rule[2]" min="0" max="100" maxlength="3"></cc-number-range>
          </div>
          ...
          <div v-for="(item, index) in form.evaluate_voice" class="score-item">
            ...
            <div class="audio-item">
              <el-upload
                ...
                list-type="text"
                :http-request="(file)=>{return uploadFile(file, 'evaluate_voice', index)}">
                <el-button><i class="iconfont icon-cloud-upload"></i> 上传音频</el-button>
              </el-upload>
              <el-button v-if="form.evaluate_voice[index]" @click="openMedia(form.evaluate_voice[index])" type="primary" plain>
        ...
        <el-form-item label="重试录音">
          <div class="audio-item">
            <el-upload
              ...
              :show-file-list="false"
              list-type="text"
              :http-request="(file)=>{return uploadFile(file, 'retry_voice')}">
              <el-button><i class="iconfont icon-cloud-upload"></i> 上传音频</el-button>
            </el-upload>
            <el-button v-if="form.retry_voice" :disabled="!form.retry_voice" @click="openMedia(form.retry_voice)">
              <i class="iconfont icon-play-circle"></i> 播放音频
            </el-button>
          </div>
        </el-form-item>
