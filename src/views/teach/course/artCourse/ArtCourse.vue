<template>
  <div class="course-management">
    <el-form inline size="small" class="section-search">
      ...
      <el-form-item>
        <el-button v-permission="'CourseCreate'" type="success" plain size="small" @click="addClass">新增美术课程</el-button>
      </el-form-item>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      async init() {
        ...
        let data = await this.ApiTeach.getArtCourseListApi(json);
        this.classList = data.items;
        this.page.total = data.total;
      },
      //删除课程
      delCourse(id) {
        this.ApiTeach.delArtCourseApi(id).then((res) => {
          this.init();
        });
      },
      handleSearch() {
      ...
      handleSwitch(id, val) {
        ...
        this.$confirm(`确定 ${_targetText} 课程？`, "提示", {
          ...
          .then(() => {
            ...
            this.ApiTeach.postArtCourseStatusApi(param)
              .then((res) => {
